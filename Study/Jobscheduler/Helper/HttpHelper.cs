...
namespace Jobscheduler.Helper
{
    ...
    public class HttpHelper
    {
        ...
        public T Get<T>(Dictionary<string, string> parameters, string requestUri) where T : class
        {
            ...
            return JsonHelper.DeserializeJsonToObject<T>(jsonString);
        }
        ...
        public string Post(object entity, string requestUri)
        {
            ...
            if (entity != null)
                request = JsonHelper.SerializeObject(entity);
        ...
        public string PostDicObj(Dictionary<string, object> para, string requestUri)
        {
            ...
            foreach (var item in para)
            {
                if (item.Value != null)
                {
                    ...
                    {
                        temp.Add(item.Key, JsonHelper.SerializeObject(item.Value));
                    }
                    else
                    {
