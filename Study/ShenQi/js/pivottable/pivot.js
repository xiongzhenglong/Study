    ...
    */
    ...
    renderers = {
        "Table": function (pvtData, opts) {
            //            for (var i = 0; i < pvtData.rowKeys.length; i++) {
            //                if (pvtData.rowKeys[i][0] === "") {
            //                    pvtData.rowKeys.splice(i, 1);
            //                    
            //                }

            //            }
            //            for (var i = 0; i < pvtData.colKeys.length; i++) {
            //                if (pvtData.colKeys[i][0] === "") {
            //                    pvtData.colKeys.splice(i, 1);
            //                }
            ...
            _fn = function (c) {
                ...
                if (keys.length > opts.menuLimit) {
                    ...
                    btns.append($("<input>").addClass("pvtSearch").attr("placeholder", opts.localeStrings.filterResults).bind("keyup", function () {
                        ...
                        return $(this).parents(".pvtFilterBox").find('label span').each(function (index, obj) {
                            var testString;
                    ...
                    btns.append($("<i>").addClass("fa fa-times fa-2x pvtCloseFilterBox").bind("click", function () {
                        $('.pvtFilterBox').hide();
                    }));
                    ...
                    for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
                        ...
                        filterItem.append($("<span>").text("" + k ));  //Rock Ma
                ...
                showFilterList = function (e) {
                    //modify by zhen
                    if ($(this).parent().parent().parent().hasClass("pvtRows")) {
                        valueList.css({
                            left: e.pageX,
                            top: e.pageY
                        }).toggle();
